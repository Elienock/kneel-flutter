...
class Country {
  ...
  /// Full display string with flag and dial code.
  String get displayWithFlag => '$flag $name ($dialCode)';

  /// Short display for selected state.
  String get shortDisplay => '$flag $dialCode';
}

/// Complete list of 195+ countries with dial codes.
...
Country? findCountryByDialCode(String dialCode) {
  try {
    return allCountries.firstWhere((c) => c.dialCode == dialCode);
  } catch (_) {
    return null;
  }
}
...
Country get defaultCountry => allCountries.firstWhere((c) => c.code == 'ZA');
